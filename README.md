...
- `agentic-ai-intro/`: Introductory documentation for the agentic AI concept

## Goal

Provide a lightweight reference for using agentic AI to create structured, artistic outputs in a guided way.
